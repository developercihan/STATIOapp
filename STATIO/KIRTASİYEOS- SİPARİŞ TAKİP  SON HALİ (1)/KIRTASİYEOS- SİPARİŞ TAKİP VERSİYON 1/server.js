...
// Basit yedekleme zamanlayıcısı (24 saatte bir)
setInterval(() => {
    console.log('Otomatik günlük yedekleme çalıştırılıyor...');
    // İleride services/dataAccess.js üzerinden çağrılacak
}, 86400000);
...
if (!process.env.VERCEL) {
    app.listen(PORT, '127.0.0.1', () => {
        console.log(`Statio Sunucusu sadece localhost üzerinden http://127.0.0.1:${PORT} adresinde çalışıyor.`);
