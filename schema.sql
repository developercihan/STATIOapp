...
CREATE TABLE "Tenant" (
    ...
    "category" TEXT NOT NULL DEFAULT 'K─▒rtasiye',
...
-- CreateIndex
CREATE UNIQUE INDEX "Product_kod_tenantId_key" ON "Product"("kod", "tenantId");

-- CreateIndex
CREATE UNIQUE INDEX "Order_publicToken_key" ON "Order"("publicToken");

-- CreateIndex
CREATE UNIQUE INDEX "Company_cariKod_tenantId_key" ON "Company"("cariKod", "tenantId");

-- CreateIndex
CREATE UNIQUE INDEX "Receivable_code_tenantId_key" ON "Receivable"("code", "tenantId");
